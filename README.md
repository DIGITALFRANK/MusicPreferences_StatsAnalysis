...
The two groups rated their "Happiness In Life".  We will use a Two-Sample Two-Tailed T-test to analyze the significance and accuracy of the equality, or the difference, in the _mean_ of their scores, with an Alpha of 0.05, or 95% confidance.
